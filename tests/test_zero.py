...
from pollock.optim import NamedOptimizer, ZeroDistributedOptimizer
from pollock.optim.zero import SlicedFlatTensor
...
from pollock.parallel.pipeline_parallel.engine import AllForwardAllBackwardPipelineEngine
from pollock.parallel.pipeline_parallel.tensor_pointer import TensorPointer
from pollock.parallel.tensor_parallel import nn
from pollock.parallel.tensor_parallel.enum import TensorParallelLinearMode
from pollock.parallel.tied_parameters import sync_tied_weights_gradients
from pollock.random import RandomStates, branch_random_state, get_current_random_state, get_synced_random_state
...
def _test_zero_optimizer_with_tp(
    ...
    for module in reference_model.modules():
        for name, param in module.named_parameters(recurse=False):
            setattr(module, name, pollockParameter(param))
